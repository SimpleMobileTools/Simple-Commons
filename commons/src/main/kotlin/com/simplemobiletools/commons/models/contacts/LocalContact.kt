...
// FIXME - Rename firstName and surname to givenName and familyName - Variables only - Not columns!!
// company -> organization
@Entity(tableName = "contacts", indices = [(Index(value = ["id"], unique = true))])
data class LocalContact(
    @PrimaryKey(autoGenerate = true) var id: Int?,
    @ColumnInfo(name = "display_name") var displayName: String,  // FIXME
    ...
    @ColumnInfo(name = "phonetic_given_name") var phoneticGivenName: String,  // FIXME
    @ColumnInfo(name = "phonetic_middle_name") var phoneticMiddleName: String,  // FIXME
    @ColumnInfo(name = "phonetic_family_name") var phoneticFamilyName: String,  // FIXME
    @ColumnInfo(name = "nickname") var nicknames: ArrayList<ContactNickname>,  // FIXME
    ...
    @ColumnInfo(name = "company") var organization: Organization,  // FIXME
    @ColumnInfo(name = "job_position") var jobPosition: String,  // Obsolete!
    @ColumnInfo(name = "websites") var websites: ArrayList<ContactWebsite>,  // FIXME
    @ColumnInfo(name = "relations") var relations: ArrayList<ContactRelation>,  // FIXME
