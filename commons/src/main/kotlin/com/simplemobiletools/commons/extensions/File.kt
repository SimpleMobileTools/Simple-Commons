...
fun File.getDefaultMimeType() = if (isVideoFast()) "video/*" else if (isImageFast()) "image/*" else if (isGif()) "image/gif" else getProperMimeType()
...
fun File.getProperMimeType(): String {
    ...
    return typesMap[absolutePath.getFilenameExtension()] ?: ""
}
